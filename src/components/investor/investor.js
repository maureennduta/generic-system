            ...
            <div className="column sm-50 lg-25">
              <Tile light={false} className="tile">
                ...
                <p>
                  ...
                  <br />
                  <br />
                  We are here to connect you to the most lucrative I.P. and
                  Brand Investments available anywhere, from around the world,
                  with no middlemen.
                  <br />
                  This is going to be a big deal. A very big deal.
                  <br />
                  <br />
                  We would love nothing more than to work with you.
                  <br />
                  <br />
